...
if __name__ == "__main__":
    ...
    output_csv_file = 'RecomposedECH6.csv'
    keywords = ['ww', 'AppleMusic', 'Kinopoisk', 'Live_Facebook', 'Live_YouTube', 
                'Netflix', 'PrimeVideo', 'SoundCloud', 'Spotify', 'Vimeo', 
                'YouTube_PC', 'YandexMusic']

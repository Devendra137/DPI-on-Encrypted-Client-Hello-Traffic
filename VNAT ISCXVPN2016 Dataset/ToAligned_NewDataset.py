...
if __name__ == "__main__":
    # Set directory path and output CSV filename
    directory = 'New_ESNI_Dataset'  # Directory containing .pcap files
    output_csv_file = 'AlignedESNI.csv'  # Output CSV file name
    
    # Updated list of keywords based on your request
    keywords = [
        "Gmail", "FileTransfer", "Vimeo", "Youtube", "ssl.gstatic", 
        "Hangout", "Netflix", "Google Services"
    ]

    # Process the directory and generate the CSV file
